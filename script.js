document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayQuizList() {
        ...
        sortedQuizzes.forEach(fileName => {
            ...
            // --- Quiz Supervision Indicator ---
            fetch(`${dataDirectory.replace(/\/+$/, '')}/${fileName}`)
                .then(r => r.json())
                .then(quizData => {
                    ...
                    let indicator = '';
                    if (generated === total) {
                        indicator = '<span class="llm-indicator" style="margin:4px;" title="This quiz set is entirely generated by an LLM">🤖 Generated</span>';
                    } else if (supervised === total) {
                        indicator = '<span class="supervised-indicator" style="margin:4px;" title="This quiz set is fully human supervised">✔ Fully Supervised</span>';
                    } else if (supervised > 0) {
                        indicator = '<span class="partial-indicator" style="margin:4px;" title="This quiz set already contains human supervised questions">⚠️ Partially Supervised</span>';
                    } else {
                        indicator = '<span class="unsupervised-indicator" style="margin:4px;" title="This quiz set generated from existing sources interpreted by an LLM and it was not yet supervised by a human">❗ Unsupervised</span>';
                    }
    ...
    function displayQuestion(index) {
        ...
        // --- Unsupervised/supervised/llm indicator logic ---
        ...
        } else if (llmGenerated) {
            indicatorHtml = `<span class=\"llm-indicator\" title=\"This question was generated by an LLM and not yet reviewed by a human\">🤖 LLM generated</span>`;
