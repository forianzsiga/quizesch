...
function _createQuizCard(quiz, onQuizSelectCallback) {
...
export function displayQuizList(quizzes, onQuizSelectCallback) {
    quizListElement.innerHTML = '';
    if (!quizzes || quizzes.length === 0) {
        quizListElement.innerHTML = '<li>No quizzes match the current filters.</li>';
    } else {
        quizzes.forEach(quiz => {
            const cardItem = _createQuizCard(quiz, onQuizSelectCallback);
...
export function displayUntaggedQuizList(quizzes, onQuizSelectCallback) {
